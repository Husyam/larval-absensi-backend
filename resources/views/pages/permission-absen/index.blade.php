                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{ route('permissions-absensi.index') }}">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($permission_absen as $permission)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <form action="{{ route('permissions-absensi.destroy', $permission->id) }}"
                                ...
                                <div class="float-right">
                                    {{ $permission_absen->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>

                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        @if ($permission_absen->image)
                                            ...
                                            <div>
                                                <img src="{{ asset('storage/permissions/' . $permission_absen->image) }}"
                                                    alt="Bukti Dukung" class="img-thumbnail mb-3" style="max-width: 200px;">
                                            </div>
                                            {{-- <p>{{ $permission_absen->image }}</p> --}}
                                        @else
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <p>
                                            @if ($permission_absen->is_approved == 1)
                                                Approved
                                            @else
                                                Not Approved
                                            @endif
                            ...
                            <div class="card-footer text-right">
                                <a href="{{ route('permissions-absensi.edit', $permission_absen->id) }}" class="btn btn-primary">Edit
